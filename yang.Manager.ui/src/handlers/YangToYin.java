                  ...
                  throws ExecutionException
                {
                  ...
                  finally
                  {
                      ...
                      namefile = namefile.substring(0, indexext); // name of file minus the extension
                          ...
                          String namefileout = filepath+ namefile + ".yin";
                          ...
                          MessageBox mb = new MessageBox(dlg.getParent(), 456);
                            ...
                            else if(result == 64) //Yes Selected
                            {
                              ...
                              dialog.setFilterNames(new String[] { "yin Files", "All Files (*.*)" });
                              dialog.setFilterExtensions(new String[] { "*.yin", "*.*" });
                              dialog.setFilterPath(filepath);
                              dialog.setFileName(namefile + ".yin");
                              dialog.open();
                          ...
                          try
                          {
                        	  ...
                        	  if(windows)
                        	  {
                        		  Findspace = Runtime.getRuntime().exec(new String[] {
                        				  "python",line, "-f", "yin", "-o", namefileout, pathfilein },null,
                      				  	f_path);
                        		  out.println("python " + line + " -f " +  "yin " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else if(linux)
                        	  {
                        		  Findspace = Runtime.getRuntime().exec(new String[] {
                                		  "pyang", "-f", "yin", "-o", namefileout, pathfilein },null,
                      				  	f_path);
                        		  out.println("pyang" + " -f " +  "yin " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else
                        	  {
                        		  IWorkbenchWindow windowErr = HandlerUtil.getActiveWorkbenchWindowChecked(event);
