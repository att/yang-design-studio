...
//KLD: This handler is created to generate a Skeleton XML file from the YANG file.
                  ...
                  throws ExecutionException
                {
                  ...
                  finally
                  {
                      ...
                      namefile = namefile.substring(0, indexext); // name of file minus the extension
                          ...
                          String namefileout = filepath+ namefile + ".xml";
                          ...
                          MessageBox mb = new MessageBox(dlg.getParent(), 456);
                            ...
                            else if(result == 64) //Yes Selected
                            {
                              ...
                              dialog.setFileName(namefile + ".xml");
                              dialog.open();
                          ...
                          try
                          {
                        	  ...
                        	  if(windows)
                        	  {
                        		  Findspace = Runtime.getRuntime().exec(new String[] {
                        				  "python",line, "-f", "sample-xml-skeleton", "-o", namefileout, pathfilein },null,
                      				  	f_path);
                        		  out.println("python " + line + " -f " +  "sample-xml-skeleton " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else if(linux)
                        	  {
                        		  Findspace = Runtime.getRuntime().exec(new String[] {
                                		  "pyang", "-f", "sample-xml-skeleton", "-o", namefileout, pathfilein },null,
                      				  	f_path);
                        		  out.println("pyang" + " -f " +  "sample-xml-skeleton " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else
                        	  {
                        		  IWorkbenchWindow windowErr = HandlerUtil.getActiveWorkbenchWindowChecked(event);
