                          ...
                          try
                          {
                        	  ...
                        	  if(windows)
                        	  {
                        		 Findspace = Runtime.getRuntime().exec(new String[] {
                        				  "python",line, "-f", "uml", "-o", namefileout, pathfilein },null,
                        				  	f_path);
                        		 out.println("python " + line + " -f " +  "uml " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else if(linux)
                        	  {
                        		  Findspace = Runtime.getRuntime().exec(new String[] {
                                		  "pyang", "-f", "uml", "-o", namefileout, pathfilein },null,
                      				  	f_path);
                        		  out.println("pyang " + "-f " +  "uml " + "-o " +  namefileout + " " + pathfilein);
                        	  }
                        	  else
                        	  {
                        		  IWorkbenchWindow windowErr = HandlerUtil.getActiveWorkbenchWindowChecked(event);
